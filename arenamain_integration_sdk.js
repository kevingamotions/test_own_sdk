...
var arenamain_anchor = document.getElementById("arenamain_anchor");
...
var arenamain_iframe = document.getElementById("arenamain_iframe");
...
arenamain_anchor.insertBefore(arenamain_anchor_custom_navbar, arenamain_iframe);

function show_arenamain_anchor(){
    if(arenamain_anchor.style.display === "none"){

	arenamain_anchor.style.display = "block";

	if(arenamain_anchor.requestFullscreen){
	    arenamain_anchor.requestFullscreen();
	}
	else if(arenamain_anchor.webkitRequestFullscreen){
	    arenamain_anchor.webkitRequestFullscreen();
	}
